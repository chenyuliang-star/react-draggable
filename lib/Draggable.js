      ...
      <DraggableCore {...draggableCoreProps} onStart={this.onDragStart} onDrag={this.onDrag} onStop={this.onDragStop}>
        {React.cloneElement(React.Children.only(children), {
          ...
          style: { 
            ...
            ...style, 
            [browserPrefixToKey('transform', browserPrefix)]: children.props.style.transform + ' ' +  style.transform
          },
          transform: ((children.props.style.transform || '') + ' ' + (svgTransform || '')).trim() || null
        })}
      </DraggableCore>
    );
  }
